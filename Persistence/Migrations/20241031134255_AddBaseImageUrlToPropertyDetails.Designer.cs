...
namespace Persistence.Migrations
{
    ...
    [Migration("20241031134255_AddBaseImageUrlToPropertyDetails")]
    partial class AddBaseImageUrlToPropertyDetails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Persistence.Entities.Listing", b =>
                {
                    b.HasOne("Persistence.Entities.RealEstateListingSite", "RealEstateListingSite")
                        .WithOne("Listing")
                        .HasForeignKey("Persistence.Entities.Listing", "RealEstateListingSiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Persistence.Entities.Property", b =>
                {
                    ...
                    b.HasOne("Persistence.Entities.PropertyType", "PropertyType")
                        .WithOne("Property")
                        .HasForeignKey("Persistence.Entities.Property", "PropertyTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
